...
This is a forked version of the repo https://github.com/Blockdaemon/solana-accountsdb-plugin-kafka  Thanks to https://github.com/terorie
...
```json
{
  ...
  "update_account_topic": "solana.devnet.account_updates",
...
- `program_whitelist`: Solana program IDs for which the updates for owned accounts are published.
